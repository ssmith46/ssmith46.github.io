...
<div class="wp-block-column is-vertically-aligned-stretch" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;flex-basis:40%"><!-- wp:group {"metadata":{"name":"Portrait Sticky Container"},"style":{"position":{"type":"sticky","top":"0px"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch","flexWrap":"nowrap"}} -->
...
<div class="wp-block-group" style="margin-top:20px;margin-bottom:20px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--20)"><!-- wp:query-title {"type":"archive"} /-->
