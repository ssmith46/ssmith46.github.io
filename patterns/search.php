...
<div class="wp-block-group"><!-- wp:query-title {"type":"search","textAlign":"left","level":2,"align":"wide","style":{"layout":{"flexSize":"clamp(0.5rem, 1vw, 1rem)","selfStretch":"fixed"}}} /-->

<!-- wp:spacer {"height":"0px","metadata":{"name":"XS"},"style":{"layout":{"flexSize":"clamp(0.5rem, 1vw, 1rem)","selfStretch":"fixed"}}} -->
<div style="height:0px" aria-hidden="true" class="wp-block-spacer"></div>
<!-- /wp:spacer -->

<!-- wp:search {"showLabel":false,"buttonText":"","buttonPosition":"button-inside","buttonUseIcon":true,"style":{"border":{"radius":"2px"}}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
